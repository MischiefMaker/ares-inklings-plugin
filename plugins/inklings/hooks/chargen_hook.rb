  ...
  module Inklings
    ...
    class ChargenHook
      ...
      def self.chargen_finalize(char)
        ...
        unless secret && goal
          if !secret
            Login.emit_ooc_if_logged_in(char, "%xh%crCharGen:%xn Please create a secret inkling describing a secret your character holds. Use: +inkling/secret <text>")
          end

          if !goal
            Login.emit_ooc_if_logged_in(char, "%xh%crCharGen:%xn Please create a goal inkling describing what your character is working toward. Use: +inkling/goal <text>")
          end
