...
#    BEFORE the last "fields" line (the one right before "end"). Do not
...
#    BEFORE the last "fields" line (the one right before "end"). Your
...
#      end
#
# 2. Add the 5 lines below INSIDE the method, BEFORE the final "[]" line
